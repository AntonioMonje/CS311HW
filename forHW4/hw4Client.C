...
//Purpose: To test binary search tree
//Algorithm/Design: Test1 test insert vertex function and showinorder function that displays the tree.Test2 test the delete functioninsert function and show inorder function.Test 3 also test the same functions as test2. Test 4 test the same functions as test 2 and test 3. the test in to make sure the functions all work perfectly at different levels of the tree.
int main()
{
  //***** test 1 **********************************************
