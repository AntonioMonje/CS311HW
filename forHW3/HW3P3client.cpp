...
//PURPOSE of the Program: To test the copy constructor and the = operator when using list and pointers so that they compare against each other.
//Algorithm/Design: You first add five elements to the list 1. then you call the copy constructor to test if it works. Then you displays list 1. Then you set L1 = l1 and then display l1. then you create a second list with four elements and then display that list. Then you set the second list to the first L@ = L1. then display list 2. then remove and element from the rear of list 1 and ddisplay it twice. then display l2.
int main()
{
  slist L1, L2;
  int temp;
